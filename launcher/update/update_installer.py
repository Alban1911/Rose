    ...
    def prepare_installation(
        ...
        try:
            with open(batch_path, "w", encoding="utf-8") as batch:
                ...
                batch.write('echo [%date% %time%] Merging plugins (preserving user-installed) >> "%LOG%"\n')
                ...
                batch.write('    robocopy "%SOURCE%\\Pengu Loader\\plugins" "%DEST%\\Pengu Loader\\plugins" /E /NFL /NDL /NJH /NJS >> "%LOG%" 2>&1\n')
                batch.write(')\n')
